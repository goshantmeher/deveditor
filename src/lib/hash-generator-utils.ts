/**
 * Utilities for hashing and crypto operations
 */

export type HashAlgorithm = 'MD5' | 'SHA-1' | 'SHA-256' | 'SHA-512';

/**
 * Generate a hash using Web Crypto API for SHA family
 * For MD5, it falls back to a custom implementation.
 */
...
// -------------------------------------------------------------
// Small, self-contained MD5 implementation (Web Crypto does not support MD5)
// -------------------------------------------------------------
