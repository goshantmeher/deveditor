            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Enter an example JSON object or array of objects into the editor. The engine immediately begins
                        analyzing the data types and structure for inference.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Choose from TypeScript, Zod, JSON Schema, or Yup. The tool translates the inferred structure
                        into the specific syntax rules of your chosen library.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        If your array contains inconsistent keys, the engine automatically marks those fields as
                        optional (<code className="text-indigo-400">?</code> in TypeScript or{' '}
                        <code className="text-indigo-400">.optional()</code> in Zod).
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Check the output for proper interface naming, union types for mixed data, and correctly nested
                        objects. Use the "Reset" button to start over with a fresh sample.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Click "Copy" to move the production-ready code to your clipboard. Since the entire analysis is
                        local, your data is never indexed or sent to an external server.
                     </p>
                  </div>
               </div>
            </div>
