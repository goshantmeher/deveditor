   ...
   function Editor(
      ...
      return (
         <div className="flex flex-col flex-1 min-h-0 w-full">
            ...
            {searchPanel && <div ref={searchPanelRef} className="shrink-0">{searchPanel}</div>}
            {internalErrorPanel && (
               <div ref={errorPanelRef} className="shrink-0">{internalErrorPanel}</div>
            )}
            <div
               className="editor-content-wrapper flex-1 min-h-0 relative"
            >
