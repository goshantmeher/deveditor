            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Simply paste your full, encoded JSON Web Token into the input editor at the top of the
                        workspace. The tool will automatically detect the three segments (Header, Payload, and
                        Signature).
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Review the Header panel to verify the signing algorithm (e.g., HS256, RS256) and token type.
                        This is crucial for verifying your backend implementation matches your token generation logic.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        The Payload panel displays all encoded claims (roles, user IDs, custom metadata). Use the "Human
                        Readable Dates" feature to instantly convert UNIX timestamps like{' '}
                        <code className="text-indigo-400">exp</code> or <code className="text-indigo-400">iat</code>{' '}
                        into actual dates.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Each decoded token undergoes a live expiration check. The tool will provide a clear badge
                        indicating if the token is currently active or has already expired, making it easy to diagnose
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Once you have finished debugging, use the "Clear" button to wipe your tokens from the local
                        state. All processing remains strictly local to your browser for ultimate privacy.
                     </p>
                  </div>
               </div>
            </div>
