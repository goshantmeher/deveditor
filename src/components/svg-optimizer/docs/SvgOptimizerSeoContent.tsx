      ...
      <article className="max-w-6xl mx-auto px-6 py-16 md:py-24 space-y-24">
         ...
         <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
               Strip down heavyweight, messy SVG exports into beautiful, minimized HTML-ready markup. Instantly cut file
               sizes without losing visual quality.
            </p>
         </div>
         ...
         <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 rounded-3xl bg-muted/30 border border-border/50 hover:border-indigo-500/30 transition-all duration-300">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  Removes useless Doctypes, comments, and empty container layers created by visual software editors like
            ...
            <div className="group p-8 rounded-3xl bg-muted/30 border border-border/50 hover:border-indigo-500/30 transition-all duration-300">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  Confidential branded logos or private UI components? Never worry about data leaks. SVGO runs entirely
                  securely in your browser memory.
               </p>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-muted/30 border border-border/50 hover:border-indigo-500/30 transition-all duration-300">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  Instantly review byte-savings and track percentage size reductions in real time. Hover visually in
                  preview mode before committing the code.
               </p>
            </div>
         </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Paste your raw SVG code or upload a file. The engine immediately begins analyzing the XML tree
                        for redundant layers and metadata.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Adjust precision levels for coordinate rounding and toggle specific plugins like "Remove Hidden
                        Elements" or "Merge Paths" to maximize byte savings.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Check the dashboard for the original vs. optimized file size. Monitor the live preview pane to
                        ensure no visual artifacts are introduced during the path-shortening process.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Inspect the resulting code for cleanliness. The tool removes Adobe Illustrator, Figma, and
                        Inkscape metadata tags while keeping your id attributes intact for CSS styling.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Download the optimized <code className="text-indigo-400">.svg</code> file or copy the string
                        directly. All processes are 100% client-side, ensuring your design assets remain private.
                     </p>
                  </div>
               </div>
            </div>
