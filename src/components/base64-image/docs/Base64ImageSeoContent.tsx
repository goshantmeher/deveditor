      ...
      <article className="max-w-6xl mx-auto px-6 py-16 md:py-24 space-y-24">
         ...
         <div className="text-center space-y-6 max-w-3xl mx-auto">
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
               Instantly preview and securely download Base64 image strings right inside your browser. Build perfectly
               private frontends without network requests.
            </p>
         </div>
         ...
         <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 rounded-3xl bg-muted/30 border border-border/50 hover:border-emerald-500/30 transition-all duration-300">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  See the decoded image dynamically. Whether it is an embedded SVG, PNG, WebP, or JPEG, it renders
                  instantly on a checkerboard background.
               </p>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-muted/30 border border-border/50 hover:border-amber-500/30 transition-all duration-300">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  Your image files are completely private. We do not upload anything. The image preview is constructed
                  using raw memory locally.
               </p>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-muted/30 border border-border/50 hover:border-indigo-500/30 transition-all duration-300">
               ...
               <p className="text-muted-foreground text-sm leading-relaxed">
                  If you need to recover an image from a stylesheet, CSS snippet, or inline JSON configuration, paste
                  the data URI and download the clean asset.
               </p>
            </div>
         </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Copy the entire Base64 string from your source. You can paste a full Data URI (starting with{' '}
                        <code className="text-emerald-400">data:image/...</code>) or just the raw encoded buffer
                        segment.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        The tool immediately attempts to reconstruct the binary image data into a visual preview. A
                        checkerboard background helps you identify transparency levels in PNG and WebP assets.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Check the info panel to see the detected MIME type, original file dimensions, and the calculated
                        storage size of the encoded string versus the raw binary.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Use the zoom controls to inspect the decoded asset for compression artifacts or padding errors.
                        This ensures the string you are menggunakan is valid for your CSS or HTML implementation.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Click "Download Image" to save the decoded binary file back to your disk. The tool automatically
                        names the file with the correct extension based on its internal headers.
                     </p>
                  </div>
               </div>
            </div>
