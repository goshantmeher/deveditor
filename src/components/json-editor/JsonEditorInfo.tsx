    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="text-sm text-muted-foreground">
          The JSON Editor provides a dual-panel interface for viewing, editing,
          and comparing JSON data with real-time validation and formatting.
        </p>
      </section>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground">
          <li>
            <strong>Dual Editor Modes:</strong> Switch between Text Editor (code
            view) and Tree View (visual hierarchy)
          </li>
          <li>
          ...
          <li>
            <strong>JSON5 Support:</strong> Automatically handles relaxed JSON
            syntax (trailing commas, unquoted keys, comments)
          </li>
          <li>
            <strong>Auto-Fix:</strong> Automatically repair common JSON syntax
            errors with one click
          </li>
          <li>
            <strong>Compare Mode:</strong> Side-by-side diff highlighting to
            compare two JSON documents
          </li>
          <li>
            <strong>Search/Filter:</strong> Filter JSON by property path (e.g.,
            &quot;favorites.books&quot; or &quot;address.details&quot;)
          </li>
        </ul>
      </section>
      ...
      <section>
        ...
        <div className="space-y-3 text-sm text-muted-foreground">
          <div className="flex items-center gap-2">
            ...
            <div>
              <strong>Text/Tree Toggle:</strong> Switch between code editor and
              visual tree view
            </div>
          </div>
          <div>
            ...
            <ul className="list-inside ml-4 mt-1 space-y-1">
              <li className="flex items-center gap-2">
                ...
                <span>
                  Standard: Readable formatting with 2-space indentation
                </span>
              </li>
              <li className="flex items-center gap-2">
                <AlignJustify className="h-4 w-4" />
      ...
      <section>
        ...
        <ul className="list-inside space-y-1 text-sm text-muted-foreground">
          ...
          <li className="flex items-center gap-2">
            ...
            <span>
              Click &quot;Fix JSON&quot; to automatically repair common issues
            </span>
          </li>
