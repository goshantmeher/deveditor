               ...
               <div className="flex gap-2">
                  <div className="flex gap-2">
                     ...
                     <input
                        ...
                        ref={fileInputRef}
                        className="hidden"
                        accept={state.mode === 'yaml-to-json' ? '.yaml,.yml' : '.json'}
         ...
         <div className="flex-none md:flex-1 flex flex-col min-w-0 bg-[#1e1e1e] border-t md:border-t-0 border-border h-[500px] md:h-full overflow-hidden">
            <div className="p-4 border-b border-white/10 flex items-center justify-between shrink-0 bg-[#181818]">
               <div className="flex items-center gap-2">
                  ...
                  <h2 className="font-semibold text-sm text-gray-200">
                     Constructed {state.mode === 'yaml-to-json' ? 'JSON' : 'YAML'}
                  </h2>
               </div>
               <div className="flex gap-2">
                  <Button
            ...
            <div className="flex-1 relative overflow-auto bg-[#1e1e1e] p-6 lg:p-8">
               {error ? (
                  ...
                  <pre
                     className={`font-mono text-[13px] whitespace-pre-wrap break-all focus:outline-none ${state.mode === 'yaml-to-json' ? 'text-gray-300' : 'text-orange-200'}`}
                  >
