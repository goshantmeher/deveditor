            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Paste your URL, text, or credentials into the main input field. The QR code updates in real-time
                        as you type, ensuring you can test scanability immediately.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Use the color picker to set your foreground and background colors. Ensure high contrast between
                        the dots and background for reliable scanning across all hardware.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Upload a center logo image. For the best result, use a high error correction (H) level to ensure
                        the code remains functional even with the center obscured.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Adjust the QR code size and padding. Select the error correction level based on whether the code
                        will be printed on high-gloss paper or displayed on a screen.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Download your code as a high-res PNG for web use, or an SVG for infinite scale in print
                        materials. All generation is client-side for maximum privacy.
                     </p>
                  </div>
               </div>
            </div>
