            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Select from Classic, Modern, or Minimal templates. Each is mathematically tuned for ATS
                        readability while maintaining a professional visual hierarchy.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Use the "Import from AI" feature to generate structured content from your raw career notes. Map
                        your accomplishments to specific JSON-ready fields automatically for a perfect import.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Add individual entries for Work Experience, Projects, and Education. Use the drag-and-drop
                        handles to reorder sections or create entirely custom categories for specific industry needs.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Monitor the PDF preview pane as you edit. Our engine renders every keystroke instantly, ensuring
                        your margins, font sizes, and page breaks are pixel-perfect before export.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Click "Download PDF" to generate your final document. The processing is 100% client-side,
                        meaning your personal career data never touches a server—it stays on your machine.
                     </p>
                  </div>
               </div>
            </div>
