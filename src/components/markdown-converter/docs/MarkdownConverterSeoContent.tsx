            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Type your content into the editor using standard markdown syntax. You can use headings,
                        bold/italic text, code blocks, and even GitHub-Flavored Markdown tables.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Watch the center panel as you type. It renders your markdown into styled HTML instantly,
                        allowing you to catch formatting errors or broken links immediately.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Switch to the "HTML" tab at the top of the output panel. Here you can see the raw, sanitized
                        HTML code generated from your markdown structure.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        The tool automatically runs your content through DOMPurify. This ensures that even if you paste
                        HTML into your markdown, any dangerous scripts or trackers are stripped away.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Click the "Copy" icon on the HTML tab. Your sanitized, production-ready code is now on your
                        clipboard, ready for your website, blog, or email template.
                     </p>
                  </div>
               </div>
            </div>
