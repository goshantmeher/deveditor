...
const DEFAULT_STATE: FontPairState = {
   ...
   headingWeight: 700,
   bodyWeight: 400,
   previewText: 'A beautiful typography system elevates your content out of the noise and creates a memorable reading experience for your audience.',
};
  ...
  theme: {
   ...
   return (
      <div className="w-full h-full flex flex-col md:flex-row bg-background overflow-hidden relative border border-border">
         ...
         {activeHeadingFont !== activeBodyFont && activeBodyFont && <link href={getFontUrl(activeBodyFont)} rel="stylesheet" />}
         ...
         <div className="flex flex-col w-full md:w-[320px] lg:w-[400px] bg-background border-b md:border-b-0 md:border-r border-border shrink-0 max-h-[50vh] md:max-h-full overflow-hidden">
            <div className="p-4 border-b border-border bg-muted/20 flex items-center justify-between shrink-0">
               ...
               <div className="flex gap-2">
                  <Button variant="ghost" size="sm" className="h-7 text-xs px-2 gap-1 text-muted-foreground hover:text-foreground" onClick={reset} title="Reset">
            ...
            <div className="flex-1 overflow-y-auto p-5 space-y-6">
               ...
               <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                     <div className="space-y-1.5">
                        <label className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Font Family</label>
                        <Select value={state.headingFont} onValueChange={(val) => setState({...state, headingFont: val, customHeadingFont: ''})}>
                           ...
                           <SelectContent>
                              {POPULAR_FONTS.map(font => <SelectItem key={font} value={font}>{font}</SelectItem>)}
                           </SelectContent>
                        </Select>
                        <Input 
                           type="text" 
                     ...
                     <div className="grid grid-cols-2 gap-4 border p-3 rounded-lg border-border bg-muted/20">
                        <div className="space-y-4">
                           <div className="flex justify-between items-center">
                              <label className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Base Size</label>
                        ...
                        <div className="space-y-4">
                           <div className="flex justify-between items-center">
                              <label className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Weight</label>
               ...
               <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                     <div className="space-y-1.5">
                        <label className="text-[11px] font-medium text-muted-foreground uppercase tracking-wider">Font Family</label>
                        <Select value={state.bodyFont} onValueChange={(val) => setState({...state, bodyFont: val, customBodyFont: ''})}>
                           <SelectTrigger className="w-full bg-background border border-border rounded-md px-3 py-2 text-sm focus:outline-none focus:ring-1 focus:ring-brand">
                              <SelectValue placeholder="Select font" />
                           </SelectTrigger>
                           <SelectContent>
            ...
            <div className="flex-1 w-full pt-14 overflow-auto">
               {activeTab === 'preview' ? (
                  <div className="p-8 md:p-16 w-full max-w-4xl mx-auto space-y-12">
                     ...
                     <div className="w-full max-w-3xl space-y-8 bg-background p-8 rounded-2xl border border-border/50 shadow-sm">
                        <div className="space-y-2">
                           ...
                           >
                              Visual hierarchy helps readers scan documents more efficiently. 
                              The contrast between {activeHeadingFont} and {activeBodyFont} establishes a clear pattern.
                           </p>
                        </div>
                        
                        <div className="grid grid-cols-2 gap-6">
                           <div className="p-4 bg-muted/30 rounded-lg border border-border/30">
                              <h3 style={{ fontFamily: `'${activeHeadingFont}', serif` }} className="text-xl font-bold mb-2">Heading Typeface</h3>
                              <div style={{ fontFamily: `'${activeBodyFont}', sans-serif`, fontSize: '0.875rem' }} className="text-muted-foreground">
                                 Used for main titles, section headers, and callouts to grab attention immediately.
                              </div>
                           </div>
                           <div className="p-4 bg-muted/30 rounded-lg border border-border/30">
                              <h3 style={{ fontFamily: `'${activeHeadingFont}', serif` }} className="text-xl font-bold mb-2">Body Typeface</h3>
                              <div style={{ fontFamily: `'${activeBodyFont}', sans-serif`, fontSize: '0.875rem' }} className="text-muted-foreground">
                  ...
                  <div className="p-6 md:p-12 w-full max-w-4xl mx-auto space-y-8">
                     <div className="space-y-3">
                        <h3 className="font-semibold flex items-center gap-2"><LinkIcon className="w-4 h-4 text-brand" /> 1. Import Fonts (HTML)</h3>
                     ...
                     <div className="space-y-3">
                        <h3 className="font-semibold flex items-center gap-2"><FileCode2 className="w-4 h-4 text-brand" /> 2. Define CSS Variables</h3>
                     ...
                     <div className="space-y-3">
                        <h3 className="font-semibold flex items-center gap-2"><FileCode2 className="w-4 h-4 text-brand" /> Optional: Tailwind Configuration</h3>
