      ...
      <div className="max-w-4xl mx-auto px-4">
         ...
         <section className="mb-8">
            ...
            <p className="text-muted-foreground leading-relaxed mb-4">
               ...
               designers featuring two distinct modes. In <strong>Editor Mode</strong>, you write HTML and CSS side-by-side with a live preview. In <strong>Generator Mode</strong>, you can use interactive slider tools to build visual components (like Flexbox layouts, intricate box shadows or gradients) to instantly get raw CSS or Tailwind objects.
            </p>
         </section>
         ...
         <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
               <li>
                  ...
                  See your HTML, CSS, or visually generated UI rendered in real-time.
               </li>
               <li>
                  <strong className="text-foreground">
                     Tailwind CSS Support
                  </strong>{' '}
                  — Tweak sliders and copy the underlying Tailwind CSS classes without reading documentation.
               </li>
               <li>
                  <strong className="text-foreground">Visual Generators</strong>{' '}
                  — Interactive UI controls for advanced features: Box Shadow, Border Radius, Flexbox, CSS Grid, Transforms, Keyframe Animations, and Gradients.
               </li>
               <li>
                  <strong className="text-foreground">Preset Templates</strong>{' '}
                  — Curated templates including Buttons, Cards, Flex/Grid Layouts, and more to quick-start testing.
               </li>
               <li>
                  <strong className="text-foreground">
                     Responsive Testing
         ...
         <section className="mb-8">
            ...
            <ol className="list-decimal list-inside text-muted-foreground space-y-2">
               <li>Select <strong>Editor Mode</strong> to write raw code: Add markup on the left, styles in the middle, and see results on the right.</li>
               <li>Select <strong>Generator Mode</strong> to build UI elements with sliders and visual inputs.</li>
         ...
         <section className="mb-8">
            ...
            <div className="space-y-4">
               ...
               <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                     Yes! Head over to the &quot;Generator Mode&quot;. You can use our interactive visual controls to create CSS properties, and output the direct equivalent code in standard CSS or Tailwind classes to instantly paste into your project.
                  </p>
               </div>
               <div>
                  <h4 className="font-medium mb-1">
                  ...
                  <p className="text-muted-foreground text-sm">
                     ...
                     including CSS Grid, Flexbox, Custom Properties, keyframe animations,
