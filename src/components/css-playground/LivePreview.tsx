...
<body>${htmlContent}</body>
   ...
   return (
      ...
      >
         ...
         <div className="flex items-center justify-between px-3 py-1.5 border-b border-border/50 bg-muted/30 shrink-0">
            <div className="flex items-center gap-1.5">
               ...
               <TooltipProvider delayDuration={300}>
                  {(Object.keys(VIEWPORT_SIZES) as ViewportSize[]).map(
                     (size) => (
                        <Tooltip key={size}>
            ...
            <div className="flex items-center gap-1.5">
               ...
               <TooltipProvider delayDuration={300}>
                  {(
                     Object.keys(PREVIEW_BACKGROUNDS) as PreviewBackground[]
                  ).map((bg) => (
                     <Tooltip key={bg}>
                        <TooltipTrigger asChild>
                           <button
                              ...
                              style={{
                                 ...
                                 backgroundImage:
                                    bg === 'checkered'
                                       ...
                                       : undefined,
                                 backgroundSize:
                                    bg === 'checkered' ? '8px 8px' : undefined,
                                 backgroundPosition:
                                    bg === 'checkered'
         ...
         {/* Preview Frame */}
         <div
            className="flex-1 flex items-start justify-center overflow-auto p-2"
