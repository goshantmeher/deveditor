            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Select your primary brand color using the picker or paste a Hex/HSL string. This acts as the
                        anchor for all derivative shades in your system.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Toggle between "Light" and "Dark" variants. The engine automatically recalibrates backgrounds
                        and foregrounds to maintain visual balance and accessibility.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Audit the contrast scores for text on background pairs. Scores are updated live to ensure your
                        theme meets AA or AAA standards before implementation.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Adjust the secondary and accent colors inferred by the algorithm. Use the sample UI components
                        to see how the palette feels in a real-world layout.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Copy the CSS variables, Tailwind configuration, or shadcn components. No data is stored
                        externally—your design tokens are generated 100% in your browser.
                     </p>
                  </div>
               </div>
            </div>
