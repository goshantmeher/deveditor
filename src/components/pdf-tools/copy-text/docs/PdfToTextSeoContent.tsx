import { Copy, Shield, Zap, Download, Eye, Globe, FileText } from 'lucide-react';
...
const features = [
   {
      ...
      description:
         'Extract all text content from every page of your PDF. Content is organized by page for easy navigation.',
   },
   {
      icon: Copy,
      color: 'amber',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 space-y-20">
         ...
         <section className="max-w-4xl mx-auto text-center space-y-6 py-16">
            ...
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto leading-relaxed">
               Upload any PDF and instantly extract all text content. Copy to clipboard with one click. Powered by
               Mozilla&apos;s PDF.js — 100% client-side.
            </p>
         </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               {[
                  ...
                  },
                  {
                     ...
                     icon: Eye,
                     title: 'View Text',
                     desc: 'All text is extracted page by page and displayed in an editable text area.',
                  },
                  {
                     step: '03',
                     icon: Copy,
                     title: 'Copy',
                     desc: 'Click "Copy Text" to copy everything to your clipboard. Paste anywhere.',
                  },
               ].map((item) => (
