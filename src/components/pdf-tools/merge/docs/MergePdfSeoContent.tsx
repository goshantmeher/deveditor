            ...
            <div className="max-w-4xl mx-auto space-y-6">
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Drag and drop all the PDF documents you want to combine into the upload zone. You can add files
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Use the drag-and-drop handles to reorder the files in the list. The final PDF will follow the
                        exact top-to-bottom sequence displayed here.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Verify that the correct files are selected by checking the file names and page counts listed in
                        the merge queue before proceeding.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Click "Merge Files". The engine joins the documents into a single cohesive PDF string instantly,
                        right in your browser's local memory.
                     </p>
                  </div>
               </div>
               ...
               <div className="flex gap-4">
                  ...
                  <div>
                     ...
                     <p className="text-muted-foreground text-sm leading-relaxed">
                        Download your merged file. All operations are 100% private and offline, ensuring your
                        confidential documents are never exposed to external servers.
                     </p>
                  </div>
               </div>
            </div>
