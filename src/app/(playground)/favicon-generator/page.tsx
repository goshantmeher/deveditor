...
export const metadata: Metadata = {
   ...
   keywords: ['favicon', 'icon generator', 'apple touch icon', 'android manifest icon', 'app clip resize', 'logo converter'],
   openGraph: {
      title: 'Free Favicon Generator & Icon Set Builder',
      description: 'Convert any image instantly into all modern favicons and mobile sizes without uploading anything to a server.',
   ...
   twitter: {
      ...
      description: 'Generate standard favicons for PWA manifests and browser tabs completely through client side rendering.',
   },
   alternates: {
